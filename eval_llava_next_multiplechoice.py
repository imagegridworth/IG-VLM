...
from pipeline_processor.llava_next_pipeline import *
...
def infer_and_eval_model(args):
    ...
    llavaPipeline = LlavaNextPipeline(
        model_name,
        path_qa,
        path_video,
        dir=path_result_dir,
